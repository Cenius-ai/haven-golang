...
▶ **[Watch the full demo video](https://cenius.ai/marketplace/p/haven)** — the complete walkthrough, playing on the project's cenius.ai page · [MP4 file](.github/media/demo.mp4)
...
### How do I self-host Haven?

Clone this repository and run `./install.sh`, then start the app as described in [`INSTALL.md`](INSTALL.md). Haven is fully self-hostable — no external services are required to try it.

### Is Haven free for commercial use?
...
Yes — and the easiest way is [remixing it on cenius.ai](https://cenius.ai/marketplace/p/haven): modifications made on the platform come with full rebrand and relicense rights over your derivative.

### How can I customize Haven without editing code?

Open it on [cenius.ai](https://cenius.ai/marketplace/p/haven) and describe the changes you want in plain English — the platform modifies the app and gives you a new, downloadable build.

### What is Haven built with?

Go. The full source in this repository is exactly what the app runs.

## License & rebranding

Released under the [MIT License](LICENSE) (© 2026 Cenius AI) — free for personal and commercial use.

**Need a customized version?** [Remix this app on cenius.ai](https://cenius.ai/marketplace/p/haven) — modifications made on the platform come with **full rebrand & relicense rights** over your derivative.
...
- 🎛️ [Remix Haven on the marketplace](https://cenius.ai/marketplace/p/haven) — open it in a workspace, prompt for changes, and ship your own version.
